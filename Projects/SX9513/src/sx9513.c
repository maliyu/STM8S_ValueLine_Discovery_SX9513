...
{ 
	...
	SX9513_Write(0x1F, 0x81);
	SX9513_Write(0x20, 0x81);
	SX9513_Write(0x21, 0x81);
	SX9513_Write(0x22, 0x81);
	SX9513_Write(0x23, 0x83);
	SX9513_Write(0x24, 0x83);
	SX9513_Write(0x25, 0x83);
	SX9513_Write(0x26, 0x83);
	SX9513_Write(0x27, 0x43);
	SX9513_Write(0x28, 0x02);
	SX9513_Write(0x29, 0x02);
	SX9513_Write(0x2A, 0x02);
	SX9513_Write(0x2B, 0x02);
	...
	SX9513_Write(0x31, 0x14);
        SX9513_Write(0x32, 0x68);
	SX9513_Write(0x33, 0x0F);
	SX9513_Write(0x34, 0x40);
	SX9513_Write(0x35, 0x40);
	SX9513_Write(0x36, 0x1D);
	SX9513_Write(0x37, 0x1A);
	SX9513_Write(0x38, 0x08);
	SX9513_Write(0x3B, 0x80);
